        ...
        <div class="mobile-navigation-section">
            <nav class="mobile-navigation">
                ...
                <div class="menu-icon" id="mobile_menu_icon">
                    ...
                    <a href="#" class="mobile-menu uppercase" id="mobile_menu"><?php print t("Main"); ?></a>
                </div>
                <div class="logo-container">
                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
        ...
        <section class="contacts-section" id="contacts" data-scroll-index="5">
            ...
            <div class="contacts-tab">
                <ul class="nav nav-pills">
                    <li id="#contacts_kyiv" class="active"><a data-toggle="pill" href="#main-office" id="#contacts_kyiv">Kyiv Office</a>
